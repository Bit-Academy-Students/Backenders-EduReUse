...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="bg-white p-6 rounded-lg m-5 shadow-lg w-full">
            ...
            <table class="w-full">
                ...
                <?php if ($users) : ?>
                    <?php foreach ($users as $user) : ?>
                        <tr class="*:p-4 *:border-t-1 *:border-slate-300 *:text-center hover:bg-slate-50 transition">
                            <td><?= ucfirst($user['naam']) ?></td>
                            <td><?= $user['email'] ?></td>
                            <td><?= explode(' ', $user['date_created'])[0] ?></td>
                            <td>
                                <select name="update-user" id="update-user" class="bg-white rounded-md p-2 border-1 border-gray-200">
