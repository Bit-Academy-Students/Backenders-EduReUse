        ...
        <div class="flex flex-wrap justify-center gap-10 mb-10">
            ...
            <div class="flex flex-col w-full md:w-[45%] bg-white p-6 rounded-lg gap-3 shadow-lg">
                ...
                <div class="flex flex-row gap-4">
                    <a href="<?= isset($_SESSION['id']) ? '/user/doneer-formulier' : '/login' ?>" class="bg-sky-500 text-white rounded-md p-1.5 w-35 mt-1 hover:bg-sky-600 transition">Donatie doen</a>
                    <a href="<?= isset($_SESSION['id']) ? '/user/aanvraag-formulier' : '/login' ?>" class="bg-sky-500 text-white rounded-md p-1.5 w-35 mt-1 hover:bg-sky-600 transition">Aanvraag indienen</a>
                </div>
