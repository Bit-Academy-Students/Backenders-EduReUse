...
<body class="bg-gray-100">
    ...
    <div class="flex flex-col justify-self-center w-[90%] max-w-300">
        <div class="flex flex-wrap justify-center items-center gap-10 my-10">
            <div class="flex flex-col w-full md:w-3/10 bg-white p-8 rounded-lg gap-3 shadow-lg self-start">
                ...
                <p class="text-slate-700">
                    Zonder er iets voor terug te vragen, gaven zij hun tijd, kennis en vertrouwen. Dit inzicht leidde tot de <b class="text-black">WailSalutem Foundation</b>, een stichting geboren uit dankbaarheid.
                </p>

            </div>

            <div class="flex flex-col w-full md:w-3/10 bg-white p-8 rounded-lg gap-4 shadow-lg self-start">
                ...
                <div>
                    ...
                    <p class="text-slate-700">
                        Hands-on ervaring met het bouwen en programmeren van robots, waardoor technische concepten tastbaar worden.
                    </p>
                </div>
                <div>
                    <h3 class="font-bold text-xl">Kunstmatige Intelligentie</h3>
                    <p class="text-slate-700">
                        Kennismaken met de principes en mogelijkheden van AI, inclusief ethische vraagstukken die hierbij komen kijken.
                    </p>
                </div>
            </div>

            <div class="flex flex-col w-full md:w-3/10 bg-white p-6 rounded-lg gap-3 shadow-lg self-start">
                <h3 class="font-bold text-2xl">Waarom we dit doen</h3>
                <p class="text-slate-700 italic">“Als ik een jongere zie stralen na het bouwen van zijn eerste robot, of een meisje haar moeder trots hoor uitleggen wat AI is, dan voel ik waarvoor ik dit doe.”</p>
                <p class="text-slate-700">Het gaat niet om wat je verdient, maar om wie je helpt. Niet om macht, maar om vertrouwen. Niet om status, maar om impact. Als je als jongere één keer hebt gevoeld dat je ertoe doet, dat iemand in jou gelooft, dan verander je. En dan kun je later ook zelf iemand zijn die het verschil maakt.</p>

                <div>
                    <h3 class="font-bold text-xl">Het Sociaal Innovatie Lab</h3>
                    <p class="text-slate-700">
                        Onze trots is het WailSalutem Social Innovation Lab. Een broedplaats waar jongeren wekelijks samenkomen om te experimenteren en oplossingen te bouwen voor maatschappelijke uitdagingen.
                    </p>
                </div>
            </div>
        </div>
