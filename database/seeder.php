...
$seeders = [
    ...
    OfferSeeder::class => [
        'table' => 'offers',
        'data' => [
            ['50x50cm printer', 1, 4, 'Printer werkt zoals verwacht', '2812 VL', 2, 2, 'https://tweakers.net/pricewatch/1033703/canon-pixma-ts5150-zwart.html?utm_source=google&utm_medium=css&utm_campaign=organic', 'default_printer_image.png'],
